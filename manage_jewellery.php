...
if( isset($_POST['Add_to_cart']))
{
    if(isset($_SESSION['cart']))
    {
        ...
        {
            echo"<script>alert('item already added'); window.location.href='jwellery.php';</script>";
        }
        else
        { 
            $id=$_GET['id'];
            ...
            echo"<script>alert('item  added'); window.location.href='jwellery.php';</script>";
       }
    }
    else{
        $id=$_GET['id'];
        ...
        $res=mysqli_query($con,$q1);
    $_SESSION['cart'][]=array('idno'=>$_GET['id'],'name'=>$_GET["item_name"],'price'=>$_POST["item_price"],'quant'=>$_POST["quant"]);
    echo"<script>alert('item  added'); window.location.href='jwellery_.php';</script>";
} 
}
